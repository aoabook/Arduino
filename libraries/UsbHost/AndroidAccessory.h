 ...
 * Hall of Fame:
 *
 * 2011 - Follower (@rancidbacon) was commissioned by Arduino to fix some
 *        issues that made the library crash 50% of the times
 *
 * 2012 - Modified by David Cuartielles & Andreas Goransson
 *        to allow other libraries extending this one and hidding it
 *
 * 2012 - DC & AG introduced a modification proposed by Rodrigo Calvo to 
 *        allow AOAP v2 devices register 
 */
...
private:
//DC&AG had to make these ones public
//      to allow other libraries extend this class
